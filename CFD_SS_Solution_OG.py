def SSSolutionFunction(meshGeneration,geometryInputs,fluidProperties,initialConditions,boundaryConditions,solverInformation,PreExamResults):
    ...
    class SS_Solution_result:
        ...
        match dimension:
            case '1D':
                # First step
                rho_vector, P_vector, T_vector, u_vector, iterations = nextStepFunction_1D(x_vector,h_vector,P_vector,T_vector,rho_vector,u_vector,dx,dt,fluidProperties,solverInformation,initialConditions,boundaryConditions,PreExamResults)
                # stacking arrays
